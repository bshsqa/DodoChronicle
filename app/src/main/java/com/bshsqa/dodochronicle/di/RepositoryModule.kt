...
import com.bshsqa.dodochronicle.data.repository.GeminiSettingsRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds @Singleton abstract fun bindGeminiSettingsRepository(impl: GeminiSettingsRepositoryImpl): GeminiSettingsRepository
